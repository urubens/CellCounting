...
def train(argv):
    ...
    if params.working_path is None:
        params.working_path = os.path.join(tempfile.gettempdir(), "cytomine")
    make_dirs(params.working_path)
    ...
    params.architecture = check_default(params.architecture, 'FCRN-A', return_list=False)
    ...
    d = 8 if params.architecture == 'FCRN-A' else 4
    ...
    # Callbacks
    checkpoint_callback = ModelCheckpoint(params.model_file, monitor='loss', save_best_only=True)
    ...
    with CytomineJob(cytomine,
        ...
        X, y = get_dataset(cytomine, params.working_path, params.cytomine_project, params.cytomine_object_term,
