...
DATASET="GANGLIONS"
ARCH="PRTR"
HP="forest_sw_output_size"
FILE=${DATASET}_${ARCH}_${HP}

#SBATCH --job-name=prtr_GANGLIONS_sw_output_size
#SBATCH --ntasks=8
#SBATCH --cpus-per-task=1
#SBATCH --time=196:00:00
#SBATCH --mem=400G
#SBATCH --output=/home/mass/ifilesets/ULG/s124930/cellcounting/logs/GANGLIONS_PRTR_sw_output_size.txt
