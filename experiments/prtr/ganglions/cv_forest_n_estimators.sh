...
DATASET="GANGLIONS"
ARCH="PRTR"
HP="forest_n_estimators"
FILE=${DATASET}_${ARCH}_${HP}

#SBATCH --job-name=prtr_GANGLIONS_n_estimators
#SBATCH --ntasks=8
#SBATCH --cpus-per-task=1
#SBATCH --time=196:00:00
#SBATCH --mem=400G
#SBATCH --output=/home/mass/ifilesets/ULG/s124930/cellcounting/logs/GANGLIONS_PRTR_forest_n_estimators.txt
...
--forest_n_estimators 1 \
--forest_n_estimators 50 \
