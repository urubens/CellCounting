...
#SBATCH --job-name=prtr_ANAPATH_min_samples_split
#SBATCH --ntasks=8
#SBATCH --cpus-per-task=1
#SBATCH --time=196:00:00
#SBATCH --mem=400G
#SBATCH --output=/home/mass/ifilesets/ULG/s124930/cellcounting/logs/ANAPATH_PRTR_forest_min_samples_split.txt
